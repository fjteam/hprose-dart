...
class Int8ListDeserializer extends BaseDeserializer<Int8List> {
  ...
  Int8List? read(Reader reader, int tag) {
    ...
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Int8List(count), IntDeserializer.instance) as Int8List?;
      default:
        return super.read(reader, tag);
    }
    ...
    switch (tag) {
      ...
      case TagList:
        return _readList(reader, (count) => Uint8ClampedList(count),
            IntDeserializer.instance) as Uint8ClampedList?;
      default:
        return super.read(reader, tag);
    }
...
class Int16ListDeserializer extends BaseDeserializer<Int16List> {
  ...
  Int16List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Int16List(count), IntDeserializer.instance) as Int16List?;
      default:
        return super.read(reader, tag);
    }
  }
...
class Int32ListDeserializer extends BaseDeserializer<Int32List> {
  ...
  Int32List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Int32List(count), IntDeserializer.instance) as Int32List?;
      default:
        return super.read(reader, tag);
    }
  }
...
class Int64ListDeserializer extends BaseDeserializer<Int64List> {
  ...
  Int64List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Int64List(count), IntDeserializer.instance) as Int64List?;
      default:
        return super.read(reader, tag);
    }
  }
...
class Uint16ListDeserializer extends BaseDeserializer<Uint16List> {
  ...
  Uint16List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Uint16List(count), IntDeserializer.instance) as Uint16List?;
      default:
        return super.read(reader, tag);
    }
  }
...
class Uint32ListDeserializer extends BaseDeserializer<Uint32List> {
  ...
  Uint32List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Uint32List(count), IntDeserializer.instance) as Uint32List?;
      default:
        return super.read(reader, tag);
    }
  }
...
class Uint64ListDeserializer extends BaseDeserializer<Uint64List> {
  ...
  Uint64List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Uint64List(count), IntDeserializer.instance) as Uint64List?;
      default:
        return super.read(reader, tag);
    }
  }
...
class Float32ListDeserializer extends BaseDeserializer<Float32List> {
  ...
  Float32List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Float32List(count), DoubleDeserializer.instance) as Float32List?;
      default:
        return super.read(reader, tag);
    }
  }
...
class Float64ListDeserializer extends BaseDeserializer<Float64List> {
  ...
  Float64List? read(Reader reader, int tag) {
    switch (tag) {
      ...
      case TagList:
        return _readList(
            reader, (count) => Float64List(count), DoubleDeserializer.instance) as Float64List?;
      default:
        return super.read(reader, tag);
    }
  }
    ...
    switch (tag) {
      ...
      case TagList:
        return _readList(reader, (count) => Int32x4List(count),
            Int32x4Deserializer.instance) as Int32x4List?;
      default:
        return super.read(reader, tag);
    }
  }
    ...
    switch (tag) {
      ...
      case TagList:
        return _readList(reader, (count) => Float32x4List(count),
            Float32x4Deserializer.instance) as Float32x4List?;
      default:
        return super.read(reader, tag);
    }
  }
    ...
    switch (tag) {
      ...
      case TagList:
        return _readList(reader, (count) => Float64x2List(count),
            Float64x2Deserializer.instance) as Float64x2List?;
      default:
        return super.read(reader, tag);
    }
  }
